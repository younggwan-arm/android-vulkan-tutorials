...
set(SHADERC_ROOT "/Users/gfan/.cdep/exploded/com.github.ggfan/shaderc/0.0.1/shaderc-headers.zip/include")
function(add_cdep_shaderc_dependency target)
  ...
  set(cdep_exploded_root "/Users/gfan/.cdep/exploded")
  ...
  execute_process(COMMAND /Library/Java/JavaVirtualMachines/jdk1.8.0_91.jdk/Contents/Home/jre/bin/java -classpath /Users/gfan/.cdep/bootstrap/downloads/679577100/cdep-0.8.6.jar io.cdep.CDep --working-folder /Users/gfan/proj/android-vulkan-tutorials/tutorial06_texture/. fetch-archive com.github.ggfan:shaderc:0.0.1 https://github.com/ggfan/shaderc/releases/download/0.0.1/shaderc-headers.zip 23993 5bfdf4f2226fb3128127c72a6c199a0abcde38b9c797e0ccbe6d6e511112ab0d)
  target_include_directories(${target} PRIVATE "${exploded_archive_folder}/shaderc-headers.zip/include")
  ...
  if(CMAKE_SYSTEM_NAME STREQUAL "Android")
    if(cdep_determined_android_runtime STREQUAL "gnustl_shared")
      if(CMAKE_SYSTEM_VERSION GREATER 23)
        ...
        elseif(cdep_determined_android_abi STREQUAL "armeabi")
        ...
        elseif(cdep_determined_android_abi STREQUAL "arm64-v8a")
          ...
          message(FATAL_ERROR "Android ABI ${cdep_determined_android_abi} is not supported by com.github.ggfan:shaderc:0.0.1 for platform ${CMAKE_SYSTEM_VERSION}. Supported: x86_64 x86 armeabi-v7a armeabi arm64-v8a ")
        endif()
      else()
        message(FATAL_ERROR "Android API level ${CMAKE_SYSTEM_VERSION} is not supported by com.github.ggfan:shaderc:0.0.1")
      endif()
    ...
    elseif(cdep_determined_android_runtime STREQUAL "gnustl_static")
      ...
      message(FATAL_ERROR "Android runtime '${cdep_determined_android_runtime}' is not supported by com.github.ggfan:shaderc:0.0.1. Supported: c++ gnustl ")
    endif()
  else()
    message(FATAL_ERROR "Target platform ${CMAKE_SYSTEM_NAME} is not supported by com.github.ggfan:shaderc:0.0.1. Supported: Android")
  endif()
